...
class Api : ObservableObject{
    ...
    func loadData(completion:@escaping ([Dog]) -> ()) {
        guard let url = URL(string: "https://api.thedogapi.com/v1/images/search?limit=100&api_key=live_Iiozpp62yWi43vdgIR8QbLZh6ZOCIBMBSRy3DlWJsHBXDb9GDetdoXpTJJpYc3m5") else {
            print("Invalid url...")
            return
        }
